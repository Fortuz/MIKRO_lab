%% Machine Learning
% Lab 7: Neural Network Training
% --- Handwritten Digits ---
%{
For this exercise, you will teach a neural network to
...
C = nnCostFunction(nn_params, input_layer_size, hidden_layer_size, ...
...
init_w1 = randInitializeWeights(input_layer_size, hidden_layer_size);
init_w2 = randInitializeWeights(hidden_layer_size, num_labels);

% Unroll parameters
initial_nn_params = [init_w1(:) ; init_w2(:)];
...
debug_C  = nnCostFunction(nn_params, input_layer_size, ...
